                    ...
                    <tr>
                        ...
                        <td>
                            @if($product->image_url)
                                <img src="{{ $product->image_url }}" alt="{{ $product->name }}" class="h-10 w-10 object-cover rounded mx-auto">
                            @else
                        ...
                        <td>{{ $product->name }}</td>
                        <td class="text-sm text-gray-600">{{ Str::limit($product->description, 60) }}</td>
